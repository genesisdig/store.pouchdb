...
PouchAdapter.prototype._findOne = function (id) {
  ...
  return this.pouch.get(id, { include_docs: true, attachments: true, binary: true  })
    .then(function (item) {
...
PouchAdapter.prototype._findBulk = function (ids) {
  ...
  var promises = _.map(ids, function (id) {
    return self.pouch.get(id, { include_docs: true, attachments: true, binary: true  })
      .then(function (item) {
        return self._convertFromPouch(item);
      })
      .catch(function (error) {
...
PouchAdapter.prototype._findAll = function () {
  ...
  this.pouch.allDocs({ include_docs: true, attachments: true, binary: true },
